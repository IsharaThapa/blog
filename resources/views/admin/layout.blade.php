...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed nav-link-item" href="{{ route('admin.blog.index') }}"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/category" data-toggle="collapse"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/testimonial" data-toggle="collapse"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @if(session('error'))
                    <div id="mess-age">
                        <p class="alert alert-success"><strong> Success : </strong>{{ session('error') }}</p>
                    </div>
                    @endif
                    @yield('content')
                </div>
